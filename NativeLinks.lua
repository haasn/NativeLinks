...
local getName =
  { achievement = drop (1) .. GetAchievementInfo
...
local translateLink = lam (3, function (t, d, n) return
  "|H" .. t .. ":" .. d .. "|h[" ..
    ((exists .. safely (getName [t]) .. splitOn ":") (d) or n) .. "]|h" end)
...
local events =
  { "CHAT_MSG_BN_WHISPER", "CHAT_MSG_CHANNEL", "CHAT_MSG_DND", "CHAT_MSG_EMOTE"
